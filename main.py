...
def predict(X_img_path, knn_clf=None, model_path=None, distance_threshold=0.6):
    ...
    return [(pred, loc) if rec else ("not found", loc) for pred, loc, rec in zip(knn_clf.predict(faces_encodings), X_face_locations, are_matches)]
